using Content.Shared._ECHO.OfferItem;
...
namespace Content.Client._ECHO.OfferItem;
...
public sealed class OfferItemSystem : SharedOfferItemSystem
{
    ...
    {
        base.Initialize();
        Subs.CVar(_cfg, EchoCCVars.OfferModeIndicatorsPointShow, OnShowOfferIndicatorsChanged, true);
    }
