...
public class RadialContainer : LayoutContainer
{
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        bool outerDecorations = (int)RadialMenu.RadialMenuConfig >= 3;
        ...
        _shader.SetParameter("innerDecorations", innerDecorations);
        _shader.SetParameter("outerDecorations", outerDecorations);
