...
public sealed partial class GraphicsTab : Control
{
    ...
    public GraphicsTab()
    {
        ...
        // ECHO-Tweak-start
        Control.AddOptionCheckBox(EchoCCVars.CenterRadialMenu, CenterRadialMenuCheckBox);
        Control.AddOptionDropDown(
            EchoCCVars.RadialMenuConfig,
            RadialMenuTypeSelector,
            [
                new OptionDropDownCVar<int>.ValueOption((int)RadialMenuType.FullDecorations, Loc.GetString("ui-options-radial-type-full")),
                new OptionDropDownCVar<int>.ValueOption((int)RadialMenuType.OuterLines, Loc.GetString("ui-options-radial-type-lines")),
                new OptionDropDownCVar<int>.ValueOption((int)RadialMenuType.Simple, Loc.GetString("ui-options-radial-type-simple")),
                new OptionDropDownCVar<int>.ValueOption((int)RadialMenuType.Legacy, Loc.GetString("ui-options-radial-type-legacy")),
            ]);
