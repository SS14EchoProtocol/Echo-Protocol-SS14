...
namespace Content.Shared._ECHO.CCCVars;
...
public sealed class CCCVars
{
    ...
    /// <summary>
    /// Number of moles threshold for sound barotrauma checks (used by DynamicAudioSystem).
    /// </summary>
    public static readonly CVarDef<float> SoundBarotraumaMoles =
        CVarDef.Create("audio.sound_barotrauma_moles", 10f, CVar.SERVERONLY);
